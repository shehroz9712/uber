    ...
    <div>
        ...
        @if(isset($id))
            {!! Form::model($data ?? null, [
                'route' => isset($id) ? ['driver.update', $id] : ['driver.store'],
                'method' => isset($id) ? 'patch' : 'post',
                'enctype' => 'multipart/form-data',
            ]) !!}
        @else
            {!! Form::open(['route' => ['driver.store'], 'method' => 'post', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) !!}
        @endif
        <div class="row">
            <div class="col-12">
                <a href="{{ route('driver.index') }}" class="btn border-radius-10 btn-dark float-right" role="button"><i
                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ Form::select(
                                        'service_id',
                                        isset($id) ? [optional($data->service)->id => optional($data->service)->name] : [],
                                        old('service_id'),
                                        [
