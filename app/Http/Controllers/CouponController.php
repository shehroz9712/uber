...
class CouponController extends Controller
{
    ...
    public function index(CouponDataTable $dataTable)
    {
        ...
        $assets = ['datatable'];
        $button = $auth_user->can('coupon add') ? '<a href="'.route('coupon.create').'" class="float-right btn btn-md border-radius-10 btn-outline-dark"><i class="fa fa-plus-circle"></i> '.__('message.add_form_title',['form' => __('message.coupon')]).'</a>' : '';
