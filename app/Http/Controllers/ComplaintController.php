...
class ComplaintController extends Controller
{
    ...
    public function index(ComplaintDataTable $dataTable)
    {
        ...
        $assets = ['datatable'];
        $button = $auth_user->can('complaint add') ? '<a href="'.route('complaint.create').'" class="float-right btn btn-md border-radius-10 btn-outline-dark"><i class="fa fa-plus-circle"></i> '.__('message.add_form_title',['form' => __('message.complaint')]).'</a>' : '';
        $complaintfilterButton = true;
        return $dataTable->render('global.datatable', compact('pageTitle','button','auth_user','complaintfilterButton'));
    }
